...
class DummyUsers extends StatefulWidget {
  const DummyUsers({Key? key}) : super(key: key);

  @override
  State<DummyUsers> createState() => _DummyUsersState();
}

class _DummyUsersState extends State<DummyUsers> {
...
class dummy {
  ...
  dummy({this.users, this.total, this.skip, this.limit});
