...
class Dummy_Laptops extends StatefulWidget {
  const Dummy_Laptops({Key? key}) : super(key: key);

  @override
  State<Dummy_Laptops> createState() => _Dummy_LaptopsState();
}

class _Dummy_LaptopsState extends State<Dummy_Laptops> {
